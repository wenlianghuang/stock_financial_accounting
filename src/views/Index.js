  ...
  return (
    <>
      ...
      <section className="header relative pt-16 items-center flex h-screen max-h-860-px">
          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            ...
            <div className="pt-32 sm:pt-0">
              <h2 className="font-semibold text-4xl text-gray-700">
                Stock & Financial - The Matt's Record And It's Detail.
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-gray-600">
                These are some website's knowledge of financial and stock that 
                I can find them when I forget these knowledges.
                Also, I will show the histogram table of my monthly record of Stock and financial
              </p>
        ...
        <img
          className="absolute top-1 b-auto right-0 pt-16 sm:w-6/12 -mt-48 sm:mt-0 w-10/12 max-h-860px"
          src={financial}
          alt="..."
        />
                ...
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-gray-600">
                        The daily income and expenditure in every financial transaction to record them,
                        so that it will transfer to <span style={{color: "#0000ff"}}>Financial Accounting</span>
                      </p>
                    </div>
                  </div>
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-gray-600">
                        Similiar to <span style={{color: "##F1C40F"}}>Financial transaction</span>, just like to record
                        the buying or selling each stock.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col min-w-0 mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <h6 className="text-xl mb-1 font-semibold">Financial Accounting</h6>
                      <p className="mb-4 text-gray-600">
                        All the daily financial transactions come to this accounting. 
                      </p>
                    </div>
                  </div>
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-gray-600">
                        All the daily stock transactions come to this accounting.
                      </p>
                    </div>
                  </div>
                </div>
